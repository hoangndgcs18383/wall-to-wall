    ...
    public partial class SpreadsheetManager
    {
            ...
            UnityAction<GstuSpreadSheet> callback)
        {
            ...
            using (request)
            {
                ...
                ValueRange rawData = JsonConvert.DeserializeObject<ValueRange>(request.downloadHandler.text);
                ...
                if (containsMergedCells)
                {
                    ...
                    SheetsRootObject root =
                        JsonConvert.DeserializeObject<SheetsRootObject>(request2.downloadHandler.text);
